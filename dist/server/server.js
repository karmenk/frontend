...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return setAuthToken; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return resetAuthToken; });
...
function setAuthToken(token) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.common['x-access-token'] = token;
}
function resetAuthToken() {
  delete axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.headers.common['x-access-token'];
}
function getToken() {
...
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(17);
/* harmony import */ var cookie__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(cookie__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
  ...
  nuxtServerInit({
    ...
    return new Promise((resolve, reject) => {
      ...
      if (Object.prototype.hasOwnProperty.call(cookies, 'x-access-token')) {
        Object(_utils_auth__WEBPACK_IMPORTED_MODULE_1__[/* setAuthToken */ "c"])(cookies['x-access-token']);
        dispatch('auth/fetch').then(result => {
          resolve(true);
        }).catch(error => {
          console.log('Provided token is invalid:', error);
          Object(_utils_auth__WEBPACK_IMPORTED_MODULE_1__[/* resetAuthToken */ "b"])();
          resolve(false);
        });
      } else {
        Object(_utils_auth__WEBPACK_IMPORTED_MODULE_1__[/* resetAuthToken */ "b"])();
...
const middleware = {};
middleware['auth'] = __webpack_require__(22);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/error.vue?vue&type=template&id=22e210da&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"container"},[_vm._ssrNode("<p>"+_vm._ssrEscape("Error details: "+_vm._s(_vm.error.message))+"</p>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/error.vue?vue&type=template&id=22e210da&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=152097aa&
var defaultvue_type_template_id_152097aa_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('Nuxt')],1)}
var defaultvue_type_template_id_152097aa_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=152097aa&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_152097aa_render,
  defaultvue_type_template_id_152097aa_staticRenderFns,
  false,
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(29), 'auth.js'); // If the environment supports hot reloading...
})(); // createStore
...
// CONCATENATED MODULE: ./api/init.js



external_axios_default.a.defaults.baseURL = undefined;
const token = external_js_cookie_default.a.get('x-access-token');

if (token) {
  Object(auth["c" /* setAuthToken */])(token);
} else {
  Object(auth["b" /* resetAuthToken */])();
}
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof /* Cannot get final name for export "default" in "./api/init.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./api/init.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
...
/* harmony default export */ var api = ({
  auth: {
    user: (token, accessToken) => external_axios_default.a.get('/user', {
      headers: {
        'x-access-token': accessToken,
        authorization: 'JWT ' + token
      }
    }),
    login: (data, token) => external_axios_default.a.post('/login', data, {
      headers: {
        authorization: 'JWT ' + token
      }
    })
...
const actions = {
  ...
  login({
    ...
    return api.auth.login(data, Object(auth["a" /* getToken */])()).then(response => {
      commit('set_user', response.data.user);
      Object(auth["c" /* setAuthToken */])(response.data.token);
      external_js_cookie_default.a.set('x-access-token', response.data.token, {
        expires: 7
      });
      return response;
    }).catch(error => {
  ...
  reset({
    ...
    commit('reset_user');
    Object(auth["b" /* resetAuthToken */])();
    external_js_cookie_default.a.remove('x-access-token');
    return Promise.resolve();
  }
